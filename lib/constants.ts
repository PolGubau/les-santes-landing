...
export const FAQS: ReadonlyArray<{ q: string; a: string }> = [
	{
		...
		a: "Les Santes 2026, la Festa Major de Mataró, se celebren del 17 al 29 de juliol de 2026.",
	},
	{
	...
	},
	{
		...
		a: "El programa inclou la gegantada inaugural, la Nit Boja (correfoc), havaneres al port, diada castellera i el castell de focs a la platja del Varador, a més de cercaviles, concerts i actes familiars cada dia del 17 al 29 de juliol.",
	},
	{
...
export const TESTER_PROGRAM = {
  ...
  */
	...
	feedbackUrl:
		"https://docs.google.com/forms/d/e/1FAIpQLScKHTl9iVsdK4j0pnmCp_2USyLqtG1N8iVlH7eFqr2ciTngXA/viewform?usp=publish-editor",
