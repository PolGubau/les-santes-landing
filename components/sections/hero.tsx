...
export function Hero() {
  return (
    <section className="relative overflow-hidden min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-16">
      {/* Background texture */}
      ...
      <nav className="absolute top-0 left-0 right-0 flex items-center justify-between px-6 py-5 max-w-5xl mx-auto w-full">
        <div className="flex items-center gap-2">
          <Image src="/icon.png" alt="Les Santes" width={32} height={32} className="rounded-lg" />
      ...
      <div className="max-w-4xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center">
        {/* Text */}
        <div className="space-y-6 animate-fade-up text-center lg:text-left">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed max-w-md mx-auto lg:mx-0">
            ...
            <strong className="text-foreground">Les Santes de Mataró</strong>. Decideix en
            segons on anar.
          </p>
            ...
            <div className="w-64 h-[520px] bg-foreground rounded-[3rem] shadow-2xl shadow-foreground/20 flex flex-col overflow-hidden border-4 border-foreground">
              ...
              <div className="flex-1 bg-[oklch(0.985_0.006_85)] flex flex-col">
                <div className="px-4 pt-4 pb-2">
                  ...
                  <div className="font-bold text-foreground text-sm">Les Santes 2026</div>
                </div>
