        ...
        <div className="space-y-6 animate-fade-up text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
            ...
            <Link
              ...
              className="flex items-center justify-center gap-2 border border-border bg-card px-6 py-3.5 rounded-xl font-medium text-sm hover:bg-muted transition-colors"
            >

              <svg aria-hidden="true" focusable="false" className="size-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 466 511.98">
                <g id="Layer_x0020_1">
